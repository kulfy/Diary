...
//reusable coredatastack
class CoreDataStack: NSObject {
    
    
    //this is a singleton for coredatastack
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.kulfy.Diary" in the application's documents Application Support directory.
